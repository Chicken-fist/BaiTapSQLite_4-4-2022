...
public class DatabaseTenHandler extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "student_tracker";
    private static final String TABLE_CONTACTS = "student";
    private static final String KEY_ID = "id";
    private static final String KEY_NAME = "name";

    public DatabaseTenHandler(@Nullable Context context) {
